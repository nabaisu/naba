...
Lexer.prototype.lex = function (text) {
    ...
    while (this.index < this.text.length) {
        ...
        if (this.isNumber(this.ch) || (this.is(".") && this.isNumber(this.peek()))) {
            this.readNumber(); // if the first is number, it enters loop and loop will update the index var
        } else if (this.is('\'"')) {
...
Lexer.prototype.readNumber = function () {
    ...
    while (this.index < this.text.length) {
        ...
        this.index++; // this is important as it joins the numbers together and sends back
    }
    this.tokens.push({
        text: number,
        value: Number(number)
